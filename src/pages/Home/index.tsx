  ...
  return (
    <>
          ...
          <DisasterColumn id="column-2">
            ...
            <DisasterContainer>
              ...
              <div className="disaster-content">
                ...
                <p>
                  Embora não seja estritamente um desastre natural, a pandemia
                  de COVID-19, que começou em 2019 e continuou em 2020 e além,
                  teve um impacto devastador em todo o mundo, resultando em
                  milhões de mortes e enormes consequências socioeconômicas.
                </p>
                <img src={Image10} alt="" />
              </div>
            </DisasterContainer>
      ...
      <FooterContainer id="foot">
        <FooterContent>
            <img className="logo" src={Logo} alt="" />
            <p> Hyago matos <br /> Ailton Marques <br /> Luiz Freitas <br /> Gabriel Carlos <br /> Carlos Portela</p>
        </FooterContent>
      </FooterContainer>
    </>
  );
